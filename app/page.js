...
export default function Home() {
  return (
   <>
   <div className="flex flex-row justify-around items-center h-screen mx-auto ">
        <div className="left-card-wrapper rounded-5 bg-blue-100 gap-2 w-[625px] h-[450px] justify-center px-20 bg-primary-1 shadow-md flex flex-col ">
            <h2 className="font-segoe-ui text-3xl  font-bold leading-32 tracking-normal text-left mb-10">SYNECT<span className="text-red-500">I</span>KS</h2>
            <h1 className="font-segoe-ui text-4xl font-bold leading-11 tracking-tighter text-left mb-5">Workflow Management</h1>
            <p className='card-text font-segoe-ui text-2xl font-semibold leading-10 tracking-tighter text-left'>
        ...
        <form action="">
            <div className='login w-96 h-72 flex flex-col justify-between'>
                <div className='login-bar w-96 h-11 bg-gray-100 p-2'>
                  <h4 className='flex two gap-7 text-black no-underline'>
                    <a href="#" >Login</a> <a href="#" >Signup</a></h4>
                </div>
